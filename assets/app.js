...
if(specs)specs.innerHTML=(d.specialties||[]).map(function(x){return'<article class="specialty-card"><div class="specialty-icon">'+(specIcons[x.icon]||specIcons.art)+'</div><span>'+e(x.eyebrow)+'</span><h3>'+e(x.title)+'</h3><p>'+e(x.detail)+'</p></article>'}).join('');
