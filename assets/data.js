...
skills:[{image:"assets/icons/photoshop.png",name:"Photoshop",level:96,detail:"대부분의 기능을 능숙하게 사용 가능"},{image:"assets/icons/3ds-max.png",name:"3ds Max",level:72,detail:"모델링 및 UV 작업 가능"},{image:"assets/icons/blender.png",name:"Blender",level:48,detail:"모델링, UV 및 렌더링 작업 가능"},{image:"assets/icons/trello.png",name:"Trello",level:72,detail:"일정 관리에 사용 가능"},{image:"assets/icons/microsoft-office.png",name:"Microsoft Office",level:72,detail:"원하는 형식의 문서 작업 가능"},{image:"assets/icons/figma.png",name:"Figma",level:72,detail:"원하는 형식의 작업 가능"},{image:"assets/icons/claude.png",name:"Claude",level:57,detail:"사전 입력, 저장소 연동 등 사용 가능"},{image:"assets/icons/unity.svg",name:"Unity",level:57,detail:"코딩을 사용하지 않은 조작, 에셋 사용, 연결 가능"}],
